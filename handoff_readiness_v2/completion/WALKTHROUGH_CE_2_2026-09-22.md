...
* **API responses ≥ 400:** 88, all accounted for: 40 analyst refusals (deliberate, shown, nothing charged), 21 × 409 `lifecycle_in_progress` (deliberate, shown, retried), 8 marketing 400s (W-CE-04's named refusal, driven), 12 cash refusals (6 report purchases, 6 organisation switches — all shown to the student with the figures), 2 delete 409s and 1 reset 409 (the end-game refusals), 1 advance-round 400 (W-CE-24), 1 deadline 409 (W-CE2-10), 1 harness 404 — and **the one 500, W-CE2-01**.
...
| **W-CE2-06** | Products, Round Results, price-adjustment notices | student | zh | The market's **English name** on an otherwise Chinese screen: *Western Europe* (51 occurrences across the zh records) in the product table's Active Markets, in the results tabs and inside an otherwise Chinese sentence — *Western Europe 中的 IronClad Field：未输入价格…* — while the same market is 西欧 on the Market Strategy tabs and the marketing page. The platform name carries an English *… Base Platform* suffix on the same table | 西欧 everywhere | P2 | any zh-CN team with a market, Products or Round Results | `p3-r2-30-products-zh-CN.jpg`, `v-results-t3-r1-zh-CN.jpg`, `records/student-play-t3-r2-zh-CN.json` `leaks` |
