...
# WALKTHROUGH 4: ten rounds, not six, so rounds 3..10 are pruned the
# same way -- the per-round decision screens repeat with different
# numbers, and the record cites rounds 1 and 2 for every control.
LATER_ROUND = re.compile(r'^p(\d)-r(10|[3-9])-(\d\d)[a-z]?-')
