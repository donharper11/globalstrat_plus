...
NAMES = {t['team_name'] for t in G['teams']} | {r.get('display_name') for r in G['roster']} | {
    'Walkthrough Instructor', 'Global Strategy Practicum', 'Consumer Electronics',
    # WALKTHROUGH 4: the five market names are NOT excused any more. Walkthrough
    # 3 allowed them here, which is part of why W-CE3-07 and W-CE3-09 had to be
    # found screen by screen. The repair claims every read is localised, so an
    # English market name on a Chinese screen is now a leak like any other.
