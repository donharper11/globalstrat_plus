...
| CC-20 | FX hedge lifecycle | Full hedge position lifecycle: open → mark-to-market per round → settle at maturity → book P&L. Currency pair expansion beyond USD/CNY if scenario demands. | CC-9 | 📝 Not drafted — FX *decision* persists (CC-13) but is inert in the engine (no `mark_to_market`) |
